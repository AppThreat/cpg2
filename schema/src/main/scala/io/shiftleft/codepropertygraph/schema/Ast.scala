      ...
      fs: FileSystem.Schema
        ...
        val astNode = builder
            .addNodeBaseType(
              name = "AST_NODE",
              comment =
                  """This is the base type for all nodes of the abstract syntax tree (AST). An AST
        ...
        val controlStructureTypes = builder.addConstants(
          ...
          Constant(
            ...
            value = "DO",
            valueType = ValueType.String,
            comment = "Represents a do statement"
          )
              .protoId(4),
          Constant(
            name = "FOR",
            value = "FOR",
            valueType = ValueType.String,
            comment = "Represents a for statement"
          )
              .protoId(5),
          Constant(
            name = "GOTO",
            value = "GOTO",
            valueType = ValueType.String,
            comment = "Represents a goto statement"
          )
              .protoId(6),
          Constant(
            name = "IF",
            value = "IF",
            valueType = ValueType.String,
            comment = "Represents an if statement"
          )
              .protoId(7),
          Constant(
            name = "ELSE",
            value = "ELSE",
            valueType = ValueType.String,
            comment = "Represents an else statement"
          )
              .protoId(8),
          Constant(
            name = "SWITCH",
          ...
          Constant(
            ...
            value = "TRY",
            valueType = ValueType.String,
            comment = "Represents a try statement"
          )
              .protoId(10),
          Constant(
            name = "THROW",
          ...
          Constant(
            ...
            value = "MATCH",
            valueType = ValueType.String,
            comment = "Represents a match expression"
          )
              .protoId(12),
          Constant(
            name = "YIELD",
            value = "YIELD",
            valueType = ValueType.String,
            comment = "Represents a yield expression"
          )
              .protoId(13)
        )
