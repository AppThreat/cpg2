...
class File(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
    ...
    /** Traverse to NAMESPACE_BLOCK via AST OUT edge.
      */
    def _namespaceBlockViaAstOut: overflowdb.traversal.Traversal[NamespaceBlock] =
        get()._namespaceBlockViaAstOut
    ...
    /** Traverse to TYPE_DECL via CONTAINS OUT edge.
      */
    def _typeDeclViaContainsOut: overflowdb.traversal.Traversal[TypeDecl] =
        get()._typeDeclViaContainsOut
...
class FileDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def _namespaceBlockViaAstOut: overflowdb.traversal.Traversal[NamespaceBlock] =
        astOut.collectAll[NamespaceBlock]
    ...
    def _typeDeclViaContainsOut: overflowdb.traversal.Traversal[TypeDecl] =
        containsOut.collectAll[TypeDecl]
    ...
    def namespaceBlock: overflowdb.traversal.Traversal[NamespaceBlock] =
        sourceFileIn.collectAll[NamespaceBlock]
