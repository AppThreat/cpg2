...
class Tag(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
    ...
    /** Traverse to IDENTIFIER via TAGGED_BY IN edge.
      */
    def _identifierViaTaggedByIn: overflowdb.traversal.Traversal[Identifier] =
        get()._identifierViaTaggedByIn
    ...
    /** Traverse to JUMP_TARGET via TAGGED_BY IN edge.
      */
    def _jumpTargetViaTaggedByIn: overflowdb.traversal.Traversal[JumpTarget] =
        get()._jumpTargetViaTaggedByIn
    ...
    /** Traverse to METHOD_REF via TAGGED_BY IN edge.
      */
    def _methodRefViaTaggedByIn: overflowdb.traversal.Traversal[MethodRef] =
        get()._methodRefViaTaggedByIn

    /** Traverse to METHOD_RETURN via TAGGED_BY IN edge.
      */
    def _methodReturnViaTaggedByIn: overflowdb.traversal.Traversal[MethodReturn] =
        get()._methodReturnViaTaggedByIn
    ...
    /** Traverse to TEMPLATE_DOM via TAGGED_BY IN edge.
      */
    def _templateDomViaTaggedByIn: overflowdb.traversal.Traversal[TemplateDom] =
        get()._templateDomViaTaggedByIn
...
class TagDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    override def propertiesMapForStorage: java.util.Map[String, Any] =
        ...
        if !(("") == value) then properties.put("VALUE", value)
    ...
    def _identifierViaTaggedByIn: overflowdb.traversal.Traversal[Identifier] =
        taggedByIn.collectAll[Identifier]
    def _importViaTaggedByIn: overflowdb.traversal.Traversal[Import] = taggedByIn.collectAll[Import]
    def _jumpTargetViaTaggedByIn: overflowdb.traversal.Traversal[JumpTarget] =
        taggedByIn.collectAll[JumpTarget]
    def _literalViaTaggedByIn: overflowdb.traversal.Traversal[Literal] =
        taggedByIn.collectAll[Literal]
    ...
    def _methodRefViaTaggedByIn: overflowdb.traversal.Traversal[MethodRef] =
        taggedByIn.collectAll[MethodRef]
    def _methodReturnViaTaggedByIn: overflowdb.traversal.Traversal[MethodReturn] =
        taggedByIn.collectAll[MethodReturn]
    ...
    def _templateDomViaTaggedByIn: overflowdb.traversal.Traversal[TemplateDom] =
        taggedByIn.collectAll[TemplateDom]
    def _typeRefViaTaggedByIn: overflowdb.traversal.Traversal[TypeRef] =
        taggedByIn.collectAll[TypeRef]
    def _unknownViaTaggedByIn: overflowdb.traversal.Traversal[Unknown] =
        taggedByIn.collectAll[Unknown]
