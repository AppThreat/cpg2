...
object TemplateDom:
    ...
    object PropertyNames:
        ...
        val Order         = "ORDER"
        val all: Set[String] =
            Set(ArgumentIndex, ArgumentName, Code, ColumnNumber, LineNumber, Name, Order)
...
class TemplateDom(
  ...
  id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */
    ...
    /** Traverse to EXPRESSION via AST OUT edge.
      */
    def _expressionViaAstOut: overflowdb.traversal.Traversal[Expression] =
        get()._expressionViaAstOut
    ...
    /** Traverse to EXPRESSION via REACHING_DEF OUT edge.
      */
    def _expressionViaReachingDefOut: overflowdb.traversal.Traversal[Expression] =
        get()._expressionViaReachingDefOut
    ...
    /** Traverse to EXPRESSION via ARGUMENT IN edge.
      */
    def _expressionViaArgumentIn: overflowdb.traversal.Traversal[Expression] =
        get()._expressionViaArgumentIn
...
class TemplateDomDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    with Expression with TemplateDomBase:
    ...
    def _expressionViaArgumentIn: overflowdb.traversal.Traversal[Expression] =
        argumentIn.collectAll[Expression]
    ...
    def reachingDefIn: Iterator[TemplateDom] =
        createAdjacentNodeScalaIteratorByOffSet[TemplateDom](8)
