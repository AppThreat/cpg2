...
object JumpTarget:
    ...
    object PropertyNames:
        ...
        val all: Set[String] =
            Set(ArgumentIndex, Code, ColumnNumber, LineNumber, Name, Order, ParserTypeName)
...
class JumpTargetDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    with AstNode with CfgNode with JumpTargetBase:
    ...
    def conditionIn: Iterator[ControlStructure] =
        createAdjacentNodeScalaIteratorByOffSet[ControlStructure](9)
