...
class ControlStructure(
  graph_4762: Graph,
  id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */
...
class ControlStructureDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    private var _controlStructureType: String =
        ControlStructure.PropertyDefaults.ControlStructureType
    ...
    def _identifierViaConditionOut: overflowdb.traversal.Traversal[Identifier] =
        conditionOut.collectAll[Identifier]
    def _jumpTargetViaConditionOut: overflowdb.traversal.Traversal[JumpTarget] =
        conditionOut.collectAll[JumpTarget]
    def _literalViaConditionOut: overflowdb.traversal.Traversal[Literal] =
        conditionOut.collectAll[Literal]
    def _methodRefViaConditionOut: overflowdb.traversal.Traversal[MethodRef] =
        conditionOut.collectAll[MethodRef]
    def _returnViaConditionOut: overflowdb.traversal.Traversal[Return] =
        conditionOut.collectAll[Return]
    def _typeRefViaConditionOut: overflowdb.traversal.Traversal[TypeRef] =
        conditionOut.collectAll[TypeRef]
    def _unknownViaConditionOut: overflowdb.traversal.Traversal[Unknown] =
        conditionOut.collectAll[Unknown]
    ...
    def reachingDefIn: Iterator[TemplateDom] =
        createAdjacentNodeScalaIteratorByOffSet[TemplateDom](18)
    ...
    override def canEqual(that: Any): Boolean =
        that != null && that.isInstanceOf[ControlStructureDb]
