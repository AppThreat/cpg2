...
object Return:
    ...
    object PropertyNames:
        ...
        val Order         = "ORDER"
        val all: Set[String] =
            Set(ArgumentIndex, ArgumentName, Code, ColumnNumber, LineNumber, Order)
...
class ReturnDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def _identifierViaArgumentOut: Option[Identifier] =
        argumentOut.collectAll[Identifier].nextOption()
    def _jumpTargetViaArgumentOut: overflowdb.traversal.Traversal[JumpTarget] =
    ...
    def _methodReturnViaCfgOut: MethodReturn =
        try cfgOut.collectAll[MethodReturn].next()
        catch
    ...
    def conditionIn: Iterator[ControlStructure] =
        createAdjacentNodeScalaIteratorByOffSet[ControlStructure](11)
