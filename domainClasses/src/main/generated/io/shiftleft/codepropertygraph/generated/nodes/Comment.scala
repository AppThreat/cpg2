...
class Comment(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
    ...
    /** Traverse to COMMENT via SOURCE_FILE IN edge.
      */
    def _commentViaSourceFileIn: overflowdb.traversal.Traversal[Comment] =
        get()._commentViaSourceFileIn
...
class CommentDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def _commentViaSourceFileIn: overflowdb.traversal.Traversal[Comment] =
        sourceFileIn.collectAll[Comment]
