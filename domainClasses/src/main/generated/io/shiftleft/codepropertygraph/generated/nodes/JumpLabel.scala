...
class JumpLabelDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    with AstNode with JumpLabelBase:
    ...
    def astIn: Iterator[ControlStructure] =
        createAdjacentNodeScalaIteratorByOffSet[ControlStructure](0)
