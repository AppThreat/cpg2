...
class TypeArgument(
  ...
  id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */
    ...
    /** Traverse to TYPE_PARAMETER via BINDS_TO OUT edge.
      */
    def _typeParameterViaBindsToOut: overflowdb.traversal.Traversal[TypeParameter] =
        get()._typeParameterViaBindsToOut
...
class TypeArgumentDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def bindsToOut: Iterator[TypeParameter] =
        createAdjacentNodeScalaIteratorByOffSet[TypeParameter](0)
    override def _bindsToOut = createAdjacentNodeScalaIteratorByOffSet[StoredNode](0)
    def _typeParameterViaBindsToOut: overflowdb.traversal.Traversal[TypeParameter] =
        bindsToOut.collectAll[TypeParameter]
