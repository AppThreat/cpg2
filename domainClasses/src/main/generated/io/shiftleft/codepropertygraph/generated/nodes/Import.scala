...
class Import(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
    ...
    /** Traverse to DEPENDENCY via IMPORTS OUT edge.
      */
    def _dependencyViaImportsOut: overflowdb.traversal.Traversal[Dependency] =
        get()._dependencyViaImportsOut
    ...
    /** Traverse to CALL via IS_CALL_FOR_IMPORT IN edge.
      */
    def _callViaIsCallForImportIn: overflowdb.traversal.Traversal[Call] =
        get()._callViaIsCallForImportIn
...
class ImportDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    with AstNode with ImportBase:
    ...
    def _dependencyViaImportsOut: overflowdb.traversal.Traversal[Dependency] =
        importsOut.collectAll[Dependency]
    ...
    def _callViaIsCallForImportIn: overflowdb.traversal.Traversal[Call] =
        isCallForImportIn.collectAll[Call]
