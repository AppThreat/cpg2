...
object TypeDecl:
    ...
    object Properties:
        ...
        val InheritsFromTypeFullName =
            new overflowdb.PropertyKey[IndexedSeq[String]]("INHERITS_FROM_TYPE_FULL_NAME")
    ...
    object Edges:
        val Out: Array[String] =
            Array("ALIAS_OF", "AST", "BINDS", "CONTAINS", "INHERITS_FROM", "SOURCE_FILE")
...
class TypeDecl(graph_4762: Graph, id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */ )
    ...
    /** Traverse to TYPE via INHERITS_FROM OUT edge.
      */
    def _typeViaInheritsFromOut: overflowdb.traversal.Traversal[Type] =
        get()._typeViaInheritsFromOut
...
class TypeDeclDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    override def propertiesMap: java.util.Map[String, Any] =
        ...
        if this._inheritsFromTypeFullName != null && this._inheritsFromTypeFullName.nonEmpty then
    ...
    def _methodViaContainsOut: overflowdb.traversal.Traversal[Method] =
        containsOut.collectAll[Method]
    ...
    def _typeViaInheritsFromOut: overflowdb.traversal.Traversal[Type] =
        inheritsFromOut.collectAll[Type]
    ...
    override def fromNewNode(newNode: NewNode, mapping: NewNode => StoredNode): Unit =
        ...
        this._inheritsFromTypeFullName =
            if newNode.asInstanceOf[NewTypeDecl].inheritsFromTypeFullName != null then
        ...
        graph.indexManager.putIfIndexed(
          "FULL_NAME",
          newNode.asInstanceOf[NewTypeDecl].fullName,
          this.ref
        )
    end fromNewNode
end TypeDeclDb
