...
class NamespaceBlockDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def _namespaceViaRefOut: overflowdb.traversal.Traversal[Namespace] =
        refOut.collectAll[Namespace]
    ...
    override def fromNewNode(newNode: NewNode, mapping: NewNode => StoredNode): Unit =
        ...
        graph.indexManager.putIfIndexed(
          "FULL_NAME",
          newNode.asInstanceOf[NewNamespaceBlock].fullName,
          this.ref
        )
end NamespaceBlockDb
