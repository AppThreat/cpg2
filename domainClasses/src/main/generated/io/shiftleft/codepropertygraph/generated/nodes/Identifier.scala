...
class IdentifierDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    with Expression with IdentifierBase:
    ...
    def _methodParameterInViaRefOut: Option[MethodParameterIn] =
        refOut.collectAll[MethodParameterIn].nextOption()
    ...
    def _controlStructureViaAstIn: Option[ControlStructure] =
        astIn.collectAll[ControlStructure].nextOption()
    ...
    def conditionIn: Iterator[ControlStructure] =
        createAdjacentNodeScalaIteratorByOffSet[ControlStructure](14)
    ...
    override def fromNewNode(newNode: NewNode, mapping: NewNode => StoredNode): Unit =
        ...
        this._dynamicTypeHintFullName =
            if newNode.asInstanceOf[NewIdentifier].dynamicTypeHintFullName != null then
        ...
        this._possibleTypes = if newNode.asInstanceOf[NewIdentifier].possibleTypes != null then
            newNode.asInstanceOf[NewIdentifier].possibleTypes
        else collection.immutable.ArraySeq.empty
