...
trait NodeTraversalImplicits extends NodeBaseTypeTraversalImplicits:
    implicit def toStoredNodeTraversalExtGen[NodeType <: StoredNode](trav: IterableOnce[NodeType])
      : StoredNodeTraversalExtGen[NodeType] = new StoredNodeTraversalExtGen(trav.iterator)

    implicit def toAnnotationTraversalExtGen[NodeType <: Annotation](trav: IterableOnce[NodeType])
    ...
    ): AnnotationLiteralTraversalExtGen[NodeType] =
        new AnnotationLiteralTraversalExtGen(trav.iterator)
    implicit def toAnnotationParameterTraversalExtGen[NodeType <: AnnotationParameter](
      trav: IterableOnce[NodeType]
    ): AnnotationParameterTraversalExtGen[NodeType] =
        new AnnotationParameterTraversalExtGen(trav.iterator)
    implicit def toAnnotationParameterAssignTraversalExtGen[NodeType <: AnnotationParameterAssign](
      trav: IterableOnce[NodeType]
    ): AnnotationParameterAssignTraversalExtGen[NodeType] =
        new AnnotationParameterAssignTraversalExtGen(trav.iterator)
    implicit def toArrayInitializerTraversalExtGen[NodeType <: ArrayInitializer](
      trav: IterableOnce[NodeType]
    ): ArrayInitializerTraversalExtGen[NodeType] =
        new ArrayInitializerTraversalExtGen(trav.iterator)
    implicit def toBindingTraversalExtGen[NodeType <: Binding](trav: IterableOnce[NodeType])
      : BindingTraversalExtGen[NodeType] = new BindingTraversalExtGen(trav.iterator)
    implicit def toBlockTraversalExtGen[NodeType <: Block](trav: IterableOnce[NodeType])
      : BlockTraversalExtGen[NodeType] = new BlockTraversalExtGen(trav.iterator)
    implicit def toCallTraversalExtGen[NodeType <: Call](trav: IterableOnce[NodeType])
      : CallTraversalExtGen[NodeType] = new CallTraversalExtGen(trav.iterator)
    ...
    implicit def toCommentTraversalExtGen[NodeType <: Comment](trav: IterableOnce[NodeType])
      : CommentTraversalExtGen[NodeType] = new CommentTraversalExtGen(trav.iterator)
    implicit def toConfigFileTraversalExtGen[NodeType <: ConfigFile](trav: IterableOnce[NodeType])
    ...
    implicit def toControlStructureTraversalExtGen[NodeType <: ControlStructure](
      trav: IterableOnce[NodeType]
    ): ControlStructureTraversalExtGen[NodeType] =
        new ControlStructureTraversalExtGen(trav.iterator)
    implicit def toDependencyTraversalExtGen[NodeType <: Dependency](trav: IterableOnce[NodeType])
    ...
    implicit def toFileTraversalExtGen[NodeType <: File](trav: IterableOnce[NodeType])
      : FileTraversalExtGen[NodeType] = new FileTraversalExtGen(trav.iterator)
    implicit def toFindingTraversalExtGen[NodeType <: Finding](trav: IterableOnce[NodeType])
      : FindingTraversalExtGen[NodeType] = new FindingTraversalExtGen(trav.iterator)
    implicit def toIdentifierTraversalExtGen[NodeType <: Identifier](trav: IterableOnce[NodeType])
      : IdentifierTraversalExtGen[NodeType] = new IdentifierTraversalExtGen(trav.iterator)
    implicit def toImportTraversalExtGen[NodeType <: Import](trav: IterableOnce[NodeType])
      : ImportTraversalExtGen[NodeType] = new ImportTraversalExtGen(trav.iterator)
    implicit def toJumpLabelTraversalExtGen[NodeType <: JumpLabel](trav: IterableOnce[NodeType])
      : JumpLabelTraversalExtGen[NodeType] = new JumpLabelTraversalExtGen(trav.iterator)
    implicit def toJumpTargetTraversalExtGen[NodeType <: JumpTarget](trav: IterableOnce[NodeType])
    ...
    implicit def toLiteralTraversalExtGen[NodeType <: Literal](trav: IterableOnce[NodeType])
      : LiteralTraversalExtGen[NodeType] = new LiteralTraversalExtGen(trav.iterator)
    implicit def toLocalTraversalExtGen[NodeType <: Local](trav: IterableOnce[NodeType])
      : LocalTraversalExtGen[NodeType] = new LocalTraversalExtGen(trav.iterator)
    implicit def toLocationTraversalExtGen[NodeType <: Location](trav: IterableOnce[NodeType])
      : LocationTraversalExtGen[NodeType] = new LocationTraversalExtGen(trav.iterator)
    implicit def toMemberTraversalExtGen[NodeType <: Member](trav: IterableOnce[NodeType])
      : MemberTraversalExtGen[NodeType] = new MemberTraversalExtGen(trav.iterator)
    implicit def toMetaDataTraversalExtGen[NodeType <: MetaData](trav: IterableOnce[NodeType])
      : MetaDataTraversalExtGen[NodeType] = new MetaDataTraversalExtGen(trav.iterator)
    implicit def toMethodTraversalExtGen[NodeType <: Method](trav: IterableOnce[NodeType])
    ...
    implicit def toMethodParameterInTraversalExtGen[NodeType <: MethodParameterIn](
      trav: IterableOnce[NodeType]
    ): MethodParameterInTraversalExtGen[NodeType] =
        new MethodParameterInTraversalExtGen(trav.iterator)
    implicit def toMethodParameterOutTraversalExtGen[NodeType <: MethodParameterOut](
      trav: IterableOnce[NodeType]
    ): MethodParameterOutTraversalExtGen[NodeType] =
        new MethodParameterOutTraversalExtGen(trav.iterator)
    implicit def toMethodRefTraversalExtGen[NodeType <: MethodRef](trav: IterableOnce[NodeType])
    ...
    implicit def toModifierTraversalExtGen[NodeType <: Modifier](trav: IterableOnce[NodeType])
      : ModifierTraversalExtGen[NodeType] = new ModifierTraversalExtGen(trav.iterator)
    implicit def toNamespaceTraversalExtGen[NodeType <: Namespace](trav: IterableOnce[NodeType])
    ...
    implicit def toReturnTraversalExtGen[NodeType <: Return](trav: IterableOnce[NodeType])
      : ReturnTraversalExtGen[NodeType] = new ReturnTraversalExtGen(trav.iterator)
    implicit def toTagTraversalExtGen[NodeType <: Tag](trav: IterableOnce[NodeType])
      : TagTraversalExtGen[NodeType] = new TagTraversalExtGen(trav.iterator)
    implicit def toTagNodePairTraversalExtGen[NodeType <: TagNodePair](trav: IterableOnce[NodeType])
      : TagNodePairTraversalExtGen[NodeType] = new TagNodePairTraversalExtGen(trav.iterator)
    implicit def toTemplateDomTraversalExtGen[NodeType <: TemplateDom](trav: IterableOnce[NodeType])
      : TemplateDomTraversalExtGen[NodeType] = new TemplateDomTraversalExtGen(trav.iterator)
    implicit def toTypeTraversalExtGen[NodeType <: Type](trav: IterableOnce[NodeType])
      : TypeTraversalExtGen[NodeType] = new TypeTraversalExtGen(trav.iterator)
    ...
    implicit def toTypeDeclTraversalExtGen[NodeType <: TypeDecl](trav: IterableOnce[NodeType])
    ...
    implicit def toTypeRefTraversalExtGen[NodeType <: TypeRef](trav: IterableOnce[NodeType])
      : TypeRefTraversalExtGen[NodeType] = new TypeRefTraversalExtGen(trav.iterator)
    implicit def toUnknownTraversalExtGen[NodeType <: Unknown](trav: IterableOnce[NodeType])
      : UnknownTraversalExtGen[NodeType] = new UnknownTraversalExtGen(trav.iterator)
end NodeTraversalImplicits

// lower priority implicits for base types
trait NodeBaseTypeTraversalImplicits extends overflowdb.traversal.Implicits:
    implicit def toAstNodeTraversalExtGen[NodeType <: AstNode](trav: IterableOnce[NodeType])
      : AstNodeTraversalExtGen[NodeType] = new AstNodeTraversalExtGen(trav.iterator)
    implicit def toCallReprTraversalExtGen[NodeType <: CallRepr](trav: IterableOnce[NodeType])
      : CallReprTraversalExtGen[NodeType] = new CallReprTraversalExtGen(trav.iterator)
    implicit def toCfgNodeTraversalExtGen[NodeType <: CfgNode](trav: IterableOnce[NodeType])
      : CfgNodeTraversalExtGen[NodeType] = new CfgNodeTraversalExtGen(trav.iterator)
    implicit def toDeclarationTraversalExtGen[NodeType <: Declaration](trav: IterableOnce[NodeType])
      : DeclarationTraversalExtGen[NodeType] = new DeclarationTraversalExtGen(trav.iterator)
    implicit def toExpressionTraversalExtGen[NodeType <: Expression](trav: IterableOnce[NodeType])
      : ExpressionTraversalExtGen[NodeType] = new ExpressionTraversalExtGen(trav.iterator)

class StoredNodeTraversalExtGen[NodeType <: StoredNode](val traversal: Iterator[NodeType])
    extends AnyVal:
