...
class AnnotationParameterAssign(
  graph_4762: Graph,
  id_4762: Long /*cf https://github.com/scala/bug/issues/4762 */
    ...
    def _annotationLiteralViaAstOut: overflowdb.traversal.Traversal[AnnotationLiteral] =
        get()._annotationLiteralViaAstOut
    ...
    /** Traverse to ARRAY_INITIALIZER via AST OUT edge.
      */
    def _arrayInitializerViaAstOut: overflowdb.traversal.Traversal[ArrayInitializer] =
        get()._arrayInitializerViaAstOut
...
class AnnotationParameterAssignDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    override def layoutInformation: NodeLayoutInformation =
        AnnotationParameterAssign.layoutInformation
    ...
    def _arrayInitializerViaAstOut: overflowdb.traversal.Traversal[ArrayInitializer] =
        astOut.collectAll[ArrayInitializer]
    ...
    def _annotationViaAstIn: overflowdb.traversal.Traversal[Annotation] =
        astIn.collectAll[Annotation]
    ...
    override def canEqual(that: Any): Boolean =
        that != null && that.isInstanceOf[AnnotationParameterAssignDb]
...
end AnnotationParameterAssignDb
