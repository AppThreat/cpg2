...
class TypeRefDb(ref: NodeRef[NodeDb]) extends NodeDb(ref) with StoredNode
    ...
    def captureOut: Iterator[ClosureBinding] =
        createAdjacentNodeScalaIteratorByOffSet[ClosureBinding](1)
    ...
    def _controlStructureViaAstIn: overflowdb.traversal.Traversal[ControlStructure] =
        astIn.collectAll[ControlStructure]
    ...
    def conditionIn: Iterator[ControlStructure] =
        createAdjacentNodeScalaIteratorByOffSet[ControlStructure](13)
    ...
    override def fromNewNode(newNode: NewNode, mapping: NewNode => StoredNode): Unit =
        ...
        this._dynamicTypeHintFullName =
            if newNode.asInstanceOf[NewTypeRef].dynamicTypeHintFullName != null then
        ...
        this._possibleTypes = if newNode.asInstanceOf[NewTypeRef].possibleTypes != null then
            newNode.asInstanceOf[NewTypeRef].possibleTypes
        else collection.immutable.ArraySeq.empty
