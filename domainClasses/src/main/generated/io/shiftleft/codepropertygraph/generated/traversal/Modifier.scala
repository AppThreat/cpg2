...
class ModifierTraversalExtGen[NodeType <: Modifier](val traversal: Iterator[NodeType])
    extends AnyVal:
    ...
    /** Traverse to nodes where the modifierType matches at least one of the regular expressions in
      * `values`
      */
    ...
    /** Traverse to nodes where modifierType does not match any of the regular expressions in
      * `values`.
      */
